    ...
    <section>
        <div className='p-8 mb-4 flex justify-center flex-wrap shrink-0'>
            <div className='bg-white max-w-sm my-3 mx-2 rounded-xl shadow hover:shadow-xl'>
                ...
                <div className='p-3'>
                    <h2 className='text-xl mb-1 font-bold'>Order Online</h2>
                    <p className='text-sm text-gray-500'>Stay home and get it delivered on your doorstep.</p>
                </div>
            </div>
            <div className='bg-white max-w-sm my-3 mx-2 rounded-xl shadow hover:shadow-xl'>
                ...
                <div className='p-3'>
                    <h2 className='text-xl mb-1 font-bold'>Dining</h2>
            ...
            <div className='bg-white max-w-sm my-3 mx-2 rounded-xl shadow hover:shadow-xl'>
                ...
                <div className='p-3'>
                    <h2 className='text-xl mb-1 font-bold'>Nightlife and Clubs</h2>
